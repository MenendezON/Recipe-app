...
RSpec.describe RecipeFood, type: :model do
  ...
  it 'is valid with a quantity, a food, and a recipe' do
    food = Food.create(name: 'Ingredient', measurement_unit: 'grams', price_dollars: 2.99)
    recipe = Recipe.create(name: 'Test Recipe', preparation_time_hours: 30, cooking_time_hours: 60, user:)
