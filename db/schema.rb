...
ActiveRecord::Schema[7.1].define(version: 2023_11_21_172654) do
  ...
  create_table "foods", force: :cascade do |t|
    ...
    t.decimal "price_dollars", default: "0.0", null: false
  ...
  create_table "inventories", force: :cascade do |t|
    t.string "name", default: "Inventory", null: false
  ...
  create_table "recipes", force: :cascade do |t|
    t.string "name"
    t.integer "preparation_time_hours", default: 10, null: false
    t.integer "cooking_time_hours", default: 10, null: false
    t.text "description"
    t.boolean "public"
    t.bigint "user_id", null: false
    t.datetime "created_at", null: false
