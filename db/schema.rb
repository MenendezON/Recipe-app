...
ActiveRecord::Schema[7.1].define(version: 2023_11_23_140008) do
  ...
  create_table "recipes", force: :cascade do |t|
    t.string "name"
    t.decimal "preparation_time_hours", default: "10.0", null: false
    t.decimal "cooking_time_hours", default: "10.0", null: false
    t.text "description"
    t.boolean "public"
    t.bigint "user_id", null: false
    t.datetime "created_at", null: false
